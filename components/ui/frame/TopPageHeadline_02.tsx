...
const TopPageHeadline_02: React.FC<TopPageHeadline_02Props> = ({
  ...
  return (
    <section className={classNames("md:max-w-[600px] w-full", className)}>
      {subtitleTop && (
        <p
          className={classNames(
            "text-base md:text-[40px] !leading-[110%] tracking-[0.03em] font-normal mb-2 text-accentColor",
            subtitleClassName
          )}
        >
          {subtitleTop}
      ...
      <h1
        className={classNames(
          "text-[50px] md:text-[64px] !leading-[110%] tracking-[0.1em] text-accentColor",
          titleClassName
        )}
      >
        {mainTitle}
      ...
      <p
        className={classNames(
          "mt-11 text-lg md:text-xl !leading-[160%] tracking-[0.05em] font-normal whitespace-pre-line",
          descriptionClassName
        )}
      >
        {description}
